...
local BGISTOP = Instance.new("ScreenGui")
local OpenFrame = Instance.new("Frame")
local OpenButton = Instance.new("TextButton")
local DestroyFrame = Instance.new("Frame")
local DestroyButton = Instance.new("TextButton")
local Main = Instance.new("Frame")
local Beaulty = Instance.new("Frame")
...
BGISTOP.Name = "BGISTOP"
BGISTOP.Parent = game.CoreGui

OpenFrame.Name = "OpenFrame"
OpenFrame.Parent = BGISTOP
OpenFrame.Active = true
OpenFrame.BackgroundColor3 = Color3.new(0.666667, 0, 0.498039)
OpenFrame.BorderSizePixel = 0
OpenFrame.Position = UDim2.new(0.00882352982, 0, 0.699145377, 0)
OpenFrame.Size = UDim2.new(0, 85, 0, 36)

OpenButton.Name = "OpenButton"
OpenButton.Parent = OpenFrame
OpenButton.BackgroundColor3 = Color3.new(0.666667, 0, 1)
OpenButton.BorderSizePixel = 0
OpenButton.Position = UDim2.new(0.0823529437, 0, 0.161616012, 0)
OpenButton.Size = UDim2.new(0, 69, 0, 24)
...
DestroyFrame.Parent = BGISTOP
DestroyFrame.Active = true
DestroyFrame.BackgroundColor3 = Color3.new(0.666667, 0, 0.498039)
DestroyFrame.BorderSizePixel = 0
DestroyFrame.Position = UDim2.new(0.00882352982, 0, 0.59497869, 0)
DestroyFrame.Size = UDim2.new(0, 85, 0, 36)

DestroyButton.Name = "DestroyButton"
DestroyButton.Parent = DestroyFrame
DestroyButton.BackgroundColor3 = Color3.new(0.666667, 0, 1)
DestroyButton.BorderSizePixel = 0
DestroyButton.Position = UDim2.new(0.0941176414, 0, 0.161616027, 0)
DestroyButton.Size = UDim2.new(0, 69, 0, 24)
DestroyButton.Font = Enum.Font.Cartoon
...
Main.Parent = BGISTOP
Main.Active = true
Main.BackgroundColor3 = Color3.new(0.694118, 0, 0.521569)
Main.BackgroundTransparency = 0.20000000298023
Main.BorderSizePixel = 0
Main.Position = UDim2.new(0.185294136, 0, 0.253787875, 0)
Main.Size = UDim2.new(0, 502, 0, 313)
Main.Visible = false
Main.Draggable = true

Beaulty.Name = "Beaulty"
Beaulty.Parent = Main
Beaulty.Active = true
Beaulty.BackgroundColor3 = Color3.new(0.47451, 0, 0.364706)
Beaulty.BackgroundTransparency = 0.20000000298023
Beaulty.BorderSizePixel = 0
Beaulty.Size = UDim2.new(0, 502, 0, 37)

Name.Name = "Name"
Name.Parent = Beaulty
Name.Active = true
Name.BackgroundColor3 = Color3.new(0.647059, 0, 0.486275)
Name.BorderSizePixel = 0
Name.Position = UDim2.new(0.0219123513, 0, 0.187721252, 0)
Name.Size = UDim2.new(0, 479, 0, 22)
...
Buttons.BackgroundTransparency = 55555
Buttons.BorderSizePixel = 0
Buttons.Position = UDim2.new(0.288235307, 0, 0.553030252, 0)
Buttons.Size = UDim2.new(0, 18, 0, 22)

reviz.Name = "reviz"
reviz.Parent = Buttons
reviz.BackgroundColor3 = Color3.new(0.666667, 0, 1)
reviz.BorderSizePixel = 0
reviz.Position = UDim2.new(0.700980306, 0, -5.47537899, 0)
reviz.Size = UDim2.new(0, 178, 0, 45)
reviz.Font = Enum.Font.Cartoon
reviz.Text = "Reviz Admin FE"
...
CMDBAR.FocusLost:connect(function(enterPressed)
	if enterPressed then
		...
		if string.sub(CMDBAR.Text, 5, 10) == ("bang ") then
			for i,v in pairs(GetPlayer(string.sub(CMDBAR.Text, 6))) do
				local Anim2 = Instance.new("Animation")
				Anim2.AnimationId = "rbxassetid://148840371"
				local track2 = lplayer.Character.Humanoid:LoadAnimation(Anim2)
...
noclip.BackgroundColor3 = Color3.new(0.666667, 0, 1)
noclip.BorderSizePixel = 0
noclip.Position = UDim2.new(0.702450991, 0, 0.461309046, 0)
noclip.Size = UDim2.new(0, 178, 0, 40)
noclip.Font = Enum.Font.Cartoon
noclip.Text = "Noclip (Press p)"
...
speed.Position = UDim2.new(0.812092066, 0, -2.39555192, 0)
speed.Size = UDim2.new(0, 178, 0, 39)
speed.Font = Enum.Font.Cartoon
speed.Text = "Speed (press X)"
speed.TextColor3 = Color3.new(0, 0, 0)
speed.TextScaled = true
speed.TextSize = 26
speed.TextStrokeTransparency = 2
...
credits.BackgroundColor3 = Color3.new(0.666667, 0, 1)
credits.BorderSizePixel = 0
credits.Position = UDim2.new(0.756536484, 0, 3.23674297, 0)
credits.Size = UDim2.new(0, 178, 0, 37)
...
local message = Instance.new("Message")
		...
		message.Text = "Script Made By EpickDeMona"
		wait(2)
		message:Destroy()
		local message2 = Instance.new("Message")
		message2.Parent = game.Workspace
		message2.Text = "Thanks for clicking this :)"
		wait(2)
		message2:Destroy()
end)

CloseGUI.Name = "CloseGUI"
CloseGUI.Parent = Buttons
CloseGUI.BackgroundColor3 = Color3.new(0.666667, 0, 0.498039)
CloseGUI.BorderSizePixel = 0
CloseGUI.Position = UDim2.new(18.1111088, 0, -7.36363649, 0)
CloseGUI.Size = UDim2.new(0, 19, 0, 17)
CloseGUI.Font = Enum.Font.Gotham
CloseGUI.Text = "X"
CloseGUI.TextColor3 = Color3.new(0.772549, 0.121569, 0.0352941)
CloseGUI.TextSize = 29
